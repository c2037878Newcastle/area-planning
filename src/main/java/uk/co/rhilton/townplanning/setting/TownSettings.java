...
public class TownSettings {
    ...
    public static final Setting<Integer> SHOP_DISTANCE = Setting.Integer("shop_distance", () -> 70);

    public static final Setting<Integer> SHOP_HEIGHT = Setting.Integer("shop_height", () -> 10);
    public static final Setting<Integer> SHOP_WIDTH = Setting.Integer("shop_width", () -> 15);
